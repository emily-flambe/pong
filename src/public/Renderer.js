...
class Renderer {
    ...
    render(gameState) {
        ...
        if (gameState.gameOver) {
            this.drawGameOverScreen(gameState.finalScore);
        }
    }
    ...
    drawGameOverScreen(finalScore) {
        ...
        this.ctx.fillText(`Final Score: ${finalScore}`, this.canvas.width / 2, this.canvas.height / 2 - 20);
        
        // Play Again instruction
        this.ctx.font = '20px monospace';
        this.ctx.fillText('Click "Play Again" to restart', this.canvas.width / 2, this.canvas.height / 2 + 40);
    }
